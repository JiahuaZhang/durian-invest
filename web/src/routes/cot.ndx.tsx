...
const URL = "https://publicreporting.cftc.gov/resource/yw9f-hn96.json?cftc_contract_market_code=20974%2B&$order=report_date_as_yyyy_mm_dd ASC"

export const Route = createFileRoute('/cot/ndx')({
    loader: async () => {
